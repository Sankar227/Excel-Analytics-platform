...
const ChartPage = () => {
  ...
  // Auth token assumed stored in localStorage
  ...
  return (
    <div
      className="mx-auto p-6 border border-gray-300 rounded-xl shadow-md bg-white flex flex-col font-sans"
      style={{
        maxWidth: "90vw",
        width: "720px",
        minHeight: "650px",
    ...
    >
      ...
      {/* <div className="mb-5 max-w-lg mx-auto w-full">
        ...
        <select
          ...
          className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-600 text-xl"
        >
        ...
        >
          ...
          chartData2D ? (
            ...
            <p className="text-center text-gray-500 mt-44 text-2xl">
              Select required axes to display 2D chart
            </p>
          )}
        </div>
      )} */}
...
//   const [selectedUploadId, setSelectedUploadId] = useState(null);
//   const [selectedFileData, setSelectedFileData] = useState(null);
//   const [activeChartType, setActiveChartType] = useState("bar2d"); // e.g. bar2d, line2d, pie2d, scatter2d, bar3d, line3d, pie3d, scatter3d
...
//           <option value="line2d">Line 2D</option>
...
//             <>
//               <div className="flex-grow">
//                 <label className="block font-semibold mb-3 text-xl">
//                   Y-Axis
//                 </label>
//                 <select
//                   value={yAxis3D}
